...
import { ParentCategoryForm } from './form/parent-category';
...
export function ParentCategory() {
  ...
  // edit
  async function editParentCategory(slug: string) {
    router.push(`/admin/parent-category/${slug}/edit`);
  }

  async function deleteParentCategory(id: number) {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}/api/parent-categories/${id}`,
        {
          method: 'DELETE',
          headers: {
            ...
            {ParentCategories?.map(
              (
                ...
                <TableRow key={index}>
                  ...
                  <TableCell className='hidden md:table-cell'>
                    {ParentCategory.createdAt?.slice(0, 10)}
                  </TableCell>
                  ...
                  <TableCell className='text-right'>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align='end'>
                        <DropdownMenuItem
                          onClick={() =>
                            editParentCategory(ParentCategory.slug)
                          }>
                          Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem
